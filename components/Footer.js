...
// Inline SVG social icons (Twitter/X, LinkedIn, Instagram)
      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 sm:col-span-2">
            <a
              href="#"
              className="flex items-center gap-2 font-display text-2xl font-extrabold tracking-tighter text-white mb-6 w-fit"
            ...
            <div className="flex gap-4">
              {socials.map(({ Icon, href, label }) => (
                <a
                  key={label}
                  href={href}
                  className="w-10 h-10 glass rounded-full flex items-center justify-center text-[#D7C7EC] hover:text-white hover:bg-[#7364E3]/20 transition-all"
                  aria-label={label}
                >
                  <Icon size={16} />
                </a>
